...
## INPUTS: python [txt with sample names] []
...
### ``cstacks``
# **PURPOSE*** This create a catalog from a subset of individuals
...
#		catalog, and you want those individuals to have the most sequence reads.
...
for line in myfile: 					#for each line in the barcode file
	...
	newstring = "zcat " + sampID + " | wc -l >> new_LineCounts.txt\n" # make line of code to run at command line
